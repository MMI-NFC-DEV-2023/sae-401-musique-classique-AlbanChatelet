...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/public/styles/global.css">${renderHead()}</head> ${renderComponent($$result, "HeaderPage", $$HeaderPage, { "data-astro-cid-ieof2kw3": true })} ${renderComponent($$result, "Layout", $$Layout, { "pageTitle": compositeur ? `D\xE9tails de ${compositeur.nom}` : "Compositeur introuvable", "data-astro-cid-ieof2kw3": true }, { "default": async ($$result2) => renderTemplate` <section class="flex flex-col items-center min-h-screen bg-black text-white py-12 pt-28 md:pt-0" data-astro-cid-ieof2kw3> ${compositeur ? renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-ieof2kw3": true }, { "default": async ($$result3) => renderTemplate` <p class="text-white papyrus text-3xl" data-astro-cid-ieof2kw3>
